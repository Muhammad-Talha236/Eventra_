...
const features = [
  ...
  { icon: Users, title: "Role-Based Access", description: "Admins, staff, volunteers, and attendees — every role has the perfect dashboard." },
    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0" style={{
          backgroundImage: "radial-gradient(circle, var(--ev-dot-grid) 1px, transparent 1px)",
          backgroundSize: "30px 30px",
        }} />
        <div className="absolute left-1/4 top-1/3 h-[400px] w-[400px] rounded-full bg-[var(--ev-accent)] opacity-[0.06] blur-[120px]" />
        <div className="absolute bottom-1/4 right-1/4 h-[300px] w-[300px] rounded-full bg-[var(--ev-accent)] opacity-[0.04] blur-[100px]" />

        <div className="relative mx-auto max-w-[1200px] px-6 pb-24 pt-20 lg:pb-32 lg:pt-28">
          <div className="mx-auto max-w-3xl text-center">
            <div className="inline-flex items-center gap-2 rounded-full border border-[var(--ev-accent-border)] bg-[var(--ev-accent-bg-subtle)] px-4 py-1.5 text-[12px] font-semibold text-[var(--ev-muted)]">
              ...
              3 Days · {events.length}+ Events · 1 Mega Festival
            </div>
